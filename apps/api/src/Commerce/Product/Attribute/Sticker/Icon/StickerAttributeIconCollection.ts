import { ProductAttrIcon } from "../../../../Core/Product/Attribute/Icon/ProductAttrIcon";
import { ProductAttrIconCollection } from "../../../../Core/Product/Attribute/Icon/ProductAttrIconCollection";
...
export class StickerAttributeIconCollection extends ProductAttrIconCollection {
	...
	public constructor() {
		...
		const baseURL = 'https://d6ce0no7ktiq.cloudfront.net';
		...
		for ( const [ material, relativeURL ] of Object.entries( materials ) ) {
			this.addIcon( new ProductAttrIcon( MaterialAttribute.ALIAS, material, baseURL + relativeURL ) )
		}

		for ( const [ shape, relativeURL ] of Object.entries( shapes ) ) {
			this.addIcon( new ProductAttrIcon( StickerSheetNameAttribute.ALIAS, shape, baseURL + relativeURL ) )
		}
	}
}
