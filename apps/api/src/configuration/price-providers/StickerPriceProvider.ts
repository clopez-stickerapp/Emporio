...
export class StickerPriceProvider extends RateBasedProductPriceProvider {
	...
	public constructor() {
		...
		rl_labels_on_sheets.addRate(new Rate(-20, true), 1)
			...
			.conditions.addCondition({ attribute: "item.productName", operator: ConditionOperators.IN, value: [ProductNames.PRODUCT_LABELS_ON_SHEET, ProductNames.PRODUCT_LABELS_ON_ROLL]});
