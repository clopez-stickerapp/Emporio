...
describe(`Test ${ProductAttrValueType.FLOAT} type`, () => {
	test('With valid values', () => {
		...
		productAttr = new ProductAttr({ name: 'test', type: ProductAttrValueType.FLOAT, multivalue: true, dynamicvalue: true });
...
describe(`Test ${ProductAttrValueType.STRING} type`, () => {
	test('With valid values', () => {
		...
		productAttr = new ProductAttr({ name: 'test', type: ProductAttrValueType.STRING, multivalue: true, dynamicvalue: true });
