...
describe("ProductService", () => {
	...
	test("getAllAttributeValueOptionsForProduct", () => {
		...
		let retrievedProduct = service.findProduct("foo", "bar");
		expect(service.getAllAttributeValueOptionsForProduct(retrievedProduct, "foo")).toEqual(["bar", "baz"]);
	});
	...
	test("getDefaultAttributeValueOptionsForProduct", () => {
		...
		let retrievedProduct = service.findProduct("foo", "bar");
		expect(service.getDefaultAttributeValueOptionsForProduct(retrievedProduct, "foo")).toEqual([]);
	});
});